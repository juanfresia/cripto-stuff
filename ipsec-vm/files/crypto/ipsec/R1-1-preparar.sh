...
# Descripcion: 	El objetivo de este script es configurar los dispositivos de red para el route 1
# Parametros: Ninguno
#
...
Debug "Configuracion Interfaces para R1 - Inicio"
#Llama al script de configuracion de interfaces de la libreria de scripts
$SCRIPTS_LIB/configurar-Interfaces.sh $R1_HOSTNAME
Debug "Configuracion Interfaces para R1 - Fin"
