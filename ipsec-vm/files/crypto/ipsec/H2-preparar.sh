...
Debug "Hostname $H2_HOSTNAME configurado"

killall dhclient3

# Configuro Interfaces de red
ifconfig eth0 $H2_IP netmask $H2_MASCARA
Debug "Interfaz eth0 configurada con IP $H2_IP"

route add -net $R1_PRIV_RED netmask $R1_PRIV_MASCARA gw $R2_PRIV_IP
Debug "ruta default $R1_PRIV_RED netmask $R1_PRIV_MASCARA gw $R2_PRIV_IP Agregada"
