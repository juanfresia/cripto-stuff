...
# Descripcion: 	El objetivo de este script es obtener la clave publica del Router 1
# Parametros: Ninguno
#
...
Debug "Copiado de clave IPSEC de R1 - Inicio"
$SCRIPTS_LIB/IPSEC-copiarClaveRemota.sh $R1_HOSTNAME
ERR=$?
Debug "Copiado de clave IPSEC de R1 - Fin"
exit $ERR
